 ...
 * @since 0.2
 */
public class EscafAopAllianceAnnotationsAuthorizingMethodInterceptor
        extends AnnotationsAuthorizingMethodInterceptor implements MethodInterceptor {

    public EscafAopAllianceAnnotationsAuthorizingMethodInterceptor() {
        ...
        interceptors.add(new EscafPermissionAnnotationMethodInterceptor(resolver));
