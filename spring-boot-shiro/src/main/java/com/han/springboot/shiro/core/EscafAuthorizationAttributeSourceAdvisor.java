...
public class EscafAuthorizationAttributeSourceAdvisor extends StaticMethodMatcherPointcutAdvisor
{

	private static final long serialVersionUID = 1L;

	private static final Logger log = LoggerFactory.getLogger(EscafAuthorizationAttributeSourceAdvisor.class);
	 ...
	 */
	public EscafAuthorizationAttributeSourceAdvisor()
	{
		setAdvice(new EscafAopAllianceAnnotationsAuthorizingMethodInterceptor());
	}
